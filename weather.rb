...
# def sentence(weather)
#   puts "The weather in #{:city} is Partly Cloudy. the temperature is #{:description} degrees Farenheit."
# end 
...
weather_hash = {
  ...
  "The temperature is #{weather[:temperature_farenheit]}"
}
puts weather_hash
